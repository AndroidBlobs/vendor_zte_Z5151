...
LOCAL_MODULE_OWNER := zte
LOCAL_SRC_FILES := proprietary/vendor/etc/camera/beautiful_app/preference_beautify0.xml
LOCAL_MODULE_TAGS := optional
...
LOCAL_MODULE_OWNER := zte
LOCAL_SRC_FILES := proprietary/vendor/etc/camera/beautiful_app/preference_beautify1.xml
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_SUFFIX := .xml
LOCAL_VENDOR_MODULE := true
